...
import cn.stylefeng.guns.timer.config.JobExecutorConfig;
import cn.stylefeng.guns.timer.config.JobHandlerConfig;
...
@SpringBootApplication(exclude = {MybatisDataSourceAutoConfiguration.class, SecurityAutoConfiguration.class,
        JobExecutorConfig.class, JobHandlerConfig.class
})
